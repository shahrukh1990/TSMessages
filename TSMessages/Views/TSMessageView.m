...
+ (NSMutableDictionary *)notificationDesign
{
    ...
    {
        NSBundle *frameworkBundle = [NSBundle bundleForClass:[TSMessageView class]];
        NSString *path = [frameworkBundle pathForResource:TSDesignFileName ofType:TSDesignFileType];
          ...
          textAlign:(NSTextAlignment)alignment
{
    ...
    if ((self = [self init]))
    {
        ...
        [self.titleLabel setShadowColor:[UIColor colorFromHexString:[current valueForKey:@"shadowColor"] alpha:1.0]];
        ...
        if ([subtitle length])
        {
            ...
            UIColor *contentTextColor = [UIColor colorFromHexString:[current valueForKey:@"contentTextColor"] alpha:1.0];
            if (!contentTextColor)
            {
        ...
        if ([buttonTitle length])
        {
            ...
            UIColor *buttonTitleShadowColor = [UIColor colorFromHexString:[current valueForKey:@"buttonTitleShadowColor"] alpha:1.0];
            ...
            UIColor *buttonTitleTextColor = [UIColor colorFromHexString:[current valueForKey:@"buttonTitleTextColor"] alpha:1.0];
